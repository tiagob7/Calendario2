...
const PERMISSION_DEFINITIONS = [
  ...
  { key: 'modules.clientes.propose', label: 'Criar Propostas' },
  { key: 'modules.ferias.view', label: 'Ver Férias' },
  { key: 'modules.ferias.create', label: 'Criar Férias' },
  { key: 'modules.ferias.manage', label: 'Gerir Férias' },
  { key: 'modules.visitas.view', label: 'Ver Visitas' },
  { key: 'modules.visitas.create', label: 'Criar Visitas' },
  { key: 'modules.visitas.manage', label: 'Gerir Visitas' },
  { key: 'modules.despesas.view', label: 'Ver Despesas' },
  { key: 'modules.despesas.create', label: 'Criar Despesas' },
  { key: 'modules.despesas.manage', label: 'Gerir Despesas' },
...
function createDefaultPermissions() {
  const perms = {
    modules: {
      ...
      clientes:  { view: false, import: false, edit: false, propose: false },
