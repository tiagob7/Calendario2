    ...
    },
    {
      ...
      permissoes: {
        modules: {
          ...
          escalas:     { view: true,  manage: false },
          clientes:    { view: true,  import: false, edit: false, propose: false },
          ferias:      { view: true,  create: true,  manage: false },
    ...
    },
    {
      ...
      permissoes: {
        modules: {
          ...
          clientes:    { view: true,  import: true,  edit: true,  propose: true  },
    ...
    },
    {
      ...
      permissoes: {
        modules: {
          ...
          reclamacoes: { view: true,  manage: true  },
          escalas:     { view: true,  manage: true  },
          clientes:    { view: true,  import: true,  edit: false, propose: true  },
